...
const EditProduct = () => {
  ...
  useEffect(() => {
    ...
    setValue(
      "discountPercentage",
      product && product.product.discountPercentage
    );
    setValue("newArrival", product?.product.newArrival);
  ...
  return (
    <div id="editProduct" className="flex bg-gray-100">
      <Sidebar />
      <div
        id="toggleBtn"
          ...
          {!show && (
            <div className="w-screen px-2 py-10">
              <form
                ...
                className="relative border  border-gray-100 space-y-3 w-full mx-auto rounded-md bg-white p-6 shadow-xl lg:p-10"
              >
